...
@section('contents')
    <form id="create-employee-form" action="{{ route('manager.createEmployeeSubmit') }}" method="post" class="needs-validation">
        {{ @csrf_field() }}
        <div class="row mb-3 has-validation">
            ...
            <div class="col-sm-9">
                <input id="verified" type="text" name="verified"
                    ...
                    value="{{ old('verified') ? old('verified') : '1' }}" placeholder="e.g 0">
        ...
        <div class="row mb-3">
            <div class="col-sm-9 offset-sm-3">
                <button id="create-employee-btn" type="submit" class="btn btn-success">Add</button>
            </div>
        </div>
    </form>
@endsection
