            ...
            <tbody>
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>{{ $user->branch && $user->branch->name ? $user->branch->name : ""  }}</td>
                        <td>@foreach ($user->permissions as $permission)
                            {{ $permission->name }},
                        @endforeach</td>
                        <td>
                            {{-- <a href="{{ route('admin.editUser', $user->id) }}" class="btn btn-primary">Edit</a> --}}
                            <a href="{{ route('manager.editEmployee', ['id' => $user->id]) }}" class="btn btn-primary">Edit</a>
                            <a href="{{ route('manager.deleteEmployee', ['id' => $user->id]) }}" id="delete-btn"
